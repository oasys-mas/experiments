"""Evaluate cybersecurity policies on testing configurations."""
...
FORMAT_STRING = "[%(asctime)s] [%(levelname)s] [%(name)s] [%(filename)25s:%(lineno)03d] %(message)s"
...
def test() -> None:
    ...
    env = cybersecurity_v0.parallel_env(
        ...
        device=device,
        buffer_size=args.testing_episodes,
